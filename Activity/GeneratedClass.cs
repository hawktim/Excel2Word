...
namespace Excel2Word.Activity
{
    ...
    {
        protected virtual void DataBinding(Table table1)
        {
        }

        // Creates a WordprocessingDocument.
        protected void CreatePackage(string filePath)
        {
        ...
        private void GenerateExtendedFilePropertiesPart1Content(ExtendedFilePropertiesPart extendedFilePropertiesPart1)
        {
            ...
            Ap.Template template1 = new Ap.Template { Text = "Normal.dotm" };
            Ap.TotalTime totalTime1 = new Ap.TotalTime { Text = "19" };
            Ap.Pages pages1 = new Ap.Pages { Text = "1" };
            Ap.Words words1 = new Ap.Words { Text = "22" };
            Ap.Characters characters1 = new Ap.Characters { Text = "127" };
            Ap.Application application1 = new Ap.Application { Text = "Microsoft Office Word" };
            Ap.DocumentSecurity documentSecurity1 = new Ap.DocumentSecurity { Text = "0" };
            Ap.Lines lines1 = new Ap.Lines { Text = "1" };
            Ap.Paragraphs paragraphs1 = new Ap.Paragraphs { Text = "1" };
            Ap.ScaleCrop scaleCrop1 = new Ap.ScaleCrop { Text = "false" };
            Ap.HeadingPairs headingPairs1 = new Ap.HeadingPairs();
            Vt.VTVector vTVector1 = new Vt.VTVector() { BaseType = Vt.VectorBaseValues.Variant, Size = (UInt32Value)2U };
            Vt.Variant variant1 = new Vt.Variant();
            Vt.VTLPSTR vTLPSTR1 = new Vt.VTLPSTR { Text = "Название" };
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphMarkRevision = "003B602A", RsidParagraphAddition = "003B602A", RsidParagraphProperties = "003B602A", RsidRunAdditionDefault = "003B602A" };
            ...
            Run run1 = new Run() { RsidRunProperties = "003B602A" };
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphAddition = "003B602A", RsidRunAdditionDefault = "003B602A" };
            ...
            TableRow tableRow1 = new TableRow() { RsidTableRowAddition = "003B602A", RsidTableRowProperties = "003B602A" };

            TableCell tableCell1 = new TableCell();

            TableCellProperties tableCellProperties1 = new TableCellProperties();
            TableCellWidth tableCellWidth1 = new TableCellWidth() { Width = "4672", Type = TableWidthUnitValues.Dxa };
            Shading shading1 = new Shading() { Val = ShadingPatternValues.Clear, Color = "auto", Fill = "808080", ThemeFill = ThemeColorValues.Background1, ThemeFillShade = "80" };

            tableCellProperties1.Append(tableCellWidth1);
            tableCellProperties1.Append(shading1);

            Paragraph paragraph3 = new Paragraph() { RsidParagraphMarkRevision = "003B602A", RsidParagraphAddition = "003B602A", RsidParagraphProperties = "003B602A", RsidRunAdditionDefault = "003B602A" };
            ...
            Run run2 = new Run() { RsidRunProperties = "003B602A" };
            ...
            Shading shading2 = new Shading() { Val = ShadingPatternValues.Clear, Color = "auto", Fill = "808080", ThemeFill = ThemeColorValues.Background1, ThemeFillShade = "80" };

            tableCellProperties2.Append(tableCellWidth2);
            tableCellProperties2.Append(shading2);

            Paragraph paragraph4 = new Paragraph() { RsidParagraphMarkRevision = "003B602A", RsidParagraphAddition = "003B602A", RsidParagraphProperties = "003B602A", RsidRunAdditionDefault = "003B602A" };
            ...
            Run run3 = new Run() { RsidRunProperties = "003B602A" };
            ...
            Text text3 = new Text { Text = "Количество задач" };
            ...
            Paragraph paragraph17 = new Paragraph() { RsidParagraphAddition = "00083366", RsidRunAdditionDefault = "00083366" };

            SectionProperties sectionProperties1 = new SectionProperties() { RsidR = "00083366" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "003B602A" };
            Rsid rsid1 = new Rsid() { Val = "00083366" };
            Rsid rsid2 = new Rsid() { Val = "003B602A" };
            Rsid rsid3 = new Rsid() { Val = "004641AF" };
            Rsid rsid4 = new Rsid() { Val = "004D2B18" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "7B1E7B15" };
            W15.ChartTrackingRefBased chartTrackingRefBased1 = new W15.ChartTrackingRefBased();
            W15.PersistentDocumentId persistentDocumentId1 = new W15.PersistentDocumentId() { Val = "{A9F74E0B-F5A5-416B-B2F3-744F6D17FE3B}" };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            Rsid rsid5 = new Rsid() { Val = "003B602A" };
        ...
        {
            document.PackageProperties.Creator = "Голуб Александр Александрович";
            document.PackageProperties.Title = "";
            document.PackageProperties.Subject = "";
            document.PackageProperties.Keywords = "";
            document.PackageProperties.Description = "";
            document.PackageProperties.Revision = "2";
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2018-08-17T09:12:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2019-12-10T08:42:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "Голуб Александр Александрович";
        }
    }
}
